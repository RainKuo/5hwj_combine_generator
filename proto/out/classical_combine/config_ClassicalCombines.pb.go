...
var file_proto_config_ClassicalCombines_proto_goTypes = []interface{}{
...
func file_proto_config_ClassicalCombines_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_config_ClassicalCombines_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClassicalCombineConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_config_ClassicalCombines_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClassicalBaseCombine); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_config_ClassicalCombines_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
